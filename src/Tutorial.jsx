...
const STEPS_KO = [
  ...
  { emoji: '✏️', title: '편집 모드', desc: '우하단 ✏️ 버튼으로 편집 모드로 전환!\n타임라인에서 드래그하여 시간 블록을 만들고\n제목, 색상, 세부 Task를 지정하세요.' },
  { emoji: '👀', title: '뷰 모드', desc: '우하단 👀 버튼으로 뷰 모드로 전환!\n현재 진행 중인 일정과 남은 시간을\n한눈에 확인할 수 있어요.' },
...
const STEPS_EN = [
  ...
  { emoji: '✏️', title: 'Edit Mode', desc: 'Tap ✏️ at bottom-right to switch to edit!\nDrag on the timeline to create time blocks.\nSet title, color, and subtasks.' },
  { emoji: '👀', title: 'View Mode', desc: 'Tap 👀 at bottom-right to switch to view!\nSee your current schedule\nand remaining time at a glance.' },
...
const STEPS_ZH = [
  ...
  { emoji: '✏️', title: '编辑模式', desc: '点击右下角 ✏️ 切换到编辑模式！\n在时间线上拖动创建时间块\n设置标题、颜色和子任务。' },
  { emoji: '👀', title: '查看模式', desc: '点击右下角 👀 切换到查看模式！\n一目了然地查看当前日程\n和剩余时间。' },
...
const STEPS_JA = [
  ...
  { emoji: '✏️', title: '編集モード', desc: '右下の ✏️ をタップして編集モードへ！\nタイムラインでドラッグして時間ブロックを作成。\nタイトル、色、サブタスクを設定。' },
  { emoji: '👀', title: 'ビューモード', desc: '右下の 👀 をタップしてビューモードへ！\n現在のスケジュールと残り時間を\n一目で確認できます。' },
